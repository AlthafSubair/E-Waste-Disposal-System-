...
$username=$_SESSION['email'];
        $qry1="select * from selling_request inner join customers on selling_request.comp_email=customers.email where req_status ='Completed' and comp_email='$username'";
