		...
		<td>
							  <li>
										...
										<i class="fa fa-university" aria-hidden="true"></i>
											...
											<h3 class="ca-sub ">company category</h3>
											</div>
										</a>
									</li>
									</td>
									<td>
									<li>
										<a href="ewaste_category.php">
										<i class="fa fa-shopping-basket" aria-hidden="true"></i>
											<div class="ca-content">
											
											<h3 class="ca-sub two">Ewaste Category</h3>
											</div>
										</a>
									</li>
									</td>
									...
									<li>
										...
										<i class="fa fa-user-plus" aria-hidden="true"></i>
											...
											<h3 class="ca-sub three">Employee</h3>
											</div>
										</a>
									</li>
									</td><td>
							  <li>
										<a href="customer_active_view.php">
										<i class="fa fa-users" aria-hidden="true"></i>
											<div class="ca-content">
											
											<h3 class="ca-sub four">Customers</h3>
											</div>
										</a>
									</li>
									</td>
									...
									<li>
										...
										<a href="admin_sellingrequest_view.php">
										<i class="fa fa-cart-arrow-down" aria-hidden="true"></i>
												<div class="ca-content">
													
													<h3 class="ca-sub ">Selling Request</h3>
												</div>
											</a>
											</li>
											</td>
									...
									<li>
										<a href="view_update_amount.php">
											
										<i class="fa fa-money" aria-hidden="true"></i>
											<div class="ca-content">
										
												<h3 class="ca-sub two">Payment</h3>
											</div>
										</a>
									</li></td><td>
									...
									<li>
										...
										<li>
										<a href="ewaste_report.php?type=new">
										<i class="fa fa-database" aria-hidden="true"></i>
											<div class="ca-content">
											
												<h3 class="ca-sub four">Report</h3>
											</div>
										</a>
									</li>
									</td>
